...
public class SysUserController {
    ...
    @GetMapping
    @PreAuthorize("hasAuthority('MENU_USER_VIEW')")
    ...
    @PostMapping
    @PreAuthorize("hasAuthority('MENU_USER_ADD')")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAuthority('MENU_USER_EDIT')")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAuthority('MENU_USER_DELETE')")
